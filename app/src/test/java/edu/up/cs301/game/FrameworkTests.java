...
public class FrameworkTests {
    ...
    public void test_createLocalGame(){
        ...
        LocalGame localGame = activity.createLocalGame(new PigState());
    ...
    public void test_saveConfigButton(){
        ...
        //TODO: Change to your game Main Activity
        PigMainActivity reloadActivity = Robolectric.buildActivity(PigMainActivity.class).create().resume().get();
    ...
    public void test_save_game() {
        ...
        //TODO: Change to your game State
        PigState tttState = new PigState();
        //TODO: Make changes to the state here
        ...
        //TODO: Change to your game State
        PigState newPigState = new PigState((PigState) Saving.readFromFile(R.string.app_name + "_test", activity));

        //Check the game states are the same
        assertTrue(tttState.equals(newPigState));
    }
